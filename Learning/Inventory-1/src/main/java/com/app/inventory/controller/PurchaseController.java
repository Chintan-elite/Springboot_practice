...
public class PurchaseController {
	...
	@PostMapping("/{itemid}")
	public ResponseEntity<PurchaseMAsterDto> addPurchaseItem(@RequestBody PurchaseMAsterDto dto,@PathVariable("itemid") int id)
	{
		...
		PurchaseMAsterDto createdPurchaseItem =  this.purchaseMasterService.createPurchase(dto);
